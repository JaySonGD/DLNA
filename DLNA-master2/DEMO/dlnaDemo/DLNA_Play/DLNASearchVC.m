...
@interface DLNASearchVC ()<UITableViewDelegate, UITableViewDataSource, DLNADelegate,YYDLNADelegate>

@property(nonatomic,strong) YYDLNA *dlnaManager;
...
- (void)viewDidLoad {
    ...
    self.dlnaManager = [YYDLNA sharedMRDLNAManager];
